...
import { Folder, File, Image, ArrowLeft, Home, Upload, Trash2, X } from 'lucide-react';
    ...
    {previewImage && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-4 rounded-lg max-w-3xl max-h-3xl relative">
            ...
            <img src={previewImage.webViewLink} alt={previewImage.name} className="max-w-full max-h-[calc(100vh-100px)]" />
